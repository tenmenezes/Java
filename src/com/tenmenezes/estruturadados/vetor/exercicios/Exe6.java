...
import com.tenmenezes.estruturadados.vetor.teste.Contato;
...
public class Exe6 {
    ...
    public static void main(String[] args) {
        ...
        criarContatosDinamicamente(lista);
    ...
    private static void imprimeTamanhoVetor(Lista<Contato> lista) {
        ...
        System.out.println(STR."Tamanho do vetor é de: \{lista.tamanho()}");
    }
    ...
    private static void pesquisarUltimoIndice(Scanner scan, Lista<Contato> lista) {
        ...
        try {
            ...
            pos = lista.ultimoIndiceDe(contato);

            System.out.println(STR."Contato encontrado na posição \{pos}");
    ...
    protected static void criarContatosDinamicamente(Lista<Contato> lista) {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            contato = new Contato();
            contato.setNome(STR."Contato \{i}");
            contato.setTelefone(STR."1111111\{i}");
            contato.setEmail(STR."contato \{i} @email.com");
