...
// CLASSE UTILITÁRIA, GERA CPF E CNPJ RANDÔMICOS E VERIFICA SE SÃO REAIS
// ORIGINAL: https://raw.githubusercontent.com/muriloferreira/utilities/master/GeraCpfCnpj.java
...
public class GerarCpfCnpj {
    ...
    public static String cpf() {
        ...
        if (comPontos)
            retorno = STR."\{n1}\{n2}\{n3}.\{n4}\{n5}\{n6}.\{n7}\{n8}\{n9}-\{d1}\{d2}";
        else
            retorno = STR."\{n1}\{n2}\{n3}\{n4}\{n5}\{n6}\{n7}\{n8}\{n9}\{d1}\{d2}";
    ...
    public static String cnpj() {
        ...
        if (comPontos)
            retorno = STR."\{n1}\{n2}.\{n3}\{n4}\{n5}.\{n6}\{n7}\{n8}/\{n9}\{n10}\{n11}\{n12}-\{d1}\{d2}";
        else
            retorno = STR."\{n1}\{n2}\{n3}\{n4}\{n5}\{n6}\{n7}\{n8}\{n9}\{n10}\{n11}\{n12}\{d1}\{d2}";
    ...
    public static String imprimeCNPJ(String CNPJ) {
        ...
        return (STR."\{CNPJ.substring(0, 2)}.\{CNPJ.substring(2, 5)}.\{CNPJ.substring(5, 8)}.\{CNPJ.substring(8, 12)}-\{CNPJ.substring(12, 14)}");
    }
